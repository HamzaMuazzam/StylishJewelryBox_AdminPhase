...
public class SeeJDBOrderbystatusDate {
     ...
     *
     */
    public SeeJDBOrderbystatusDate() {
    }
     ...
     */
    public SeeJDBOrderbystatusDate(String last7DaysOrders, String last30DaysOrders, String currentdateorder) {
        super();
