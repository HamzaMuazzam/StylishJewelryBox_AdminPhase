...
public class GetunAssignedOrdersByParameter_ViewHolder extends RecyclerView.ViewHolder {
    TextView tv_oderdate, tv_orderid, tv_locationa,tv_orderstatus;

    public GetunAssignedOrdersByParameter_ViewHolder(@NonNull View itemView) {
        super(itemView);
